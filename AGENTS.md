...
- Future model, command, validation, renderer, AI, persistence, and history folders should be added only when those steps are implemented.
...
- No backend.
- No real AI API.
- No localStorage persistence in Step 1.
- No template renderer, command executor, or history restore behavior in Step 1.
